                ...
                <div class="m-auto">
                    <div class="float-right">
                        ...
                        <form action="/cars/{{$car->id}}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="border-b-2 pb-2 mt-5 border-dotted italic text-red-500">Delete &rarr;</button>
                        </form>
                    </div>
                    ...
                    <img src="{{asset('images/' . $car->image_path)}}" alt="foto" class="w-4/12 mb-8 mt-8 shadow-xl">
